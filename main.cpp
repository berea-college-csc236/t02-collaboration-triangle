/*  T02: Collaboration Teamwork
    ...
    TODO: <Samundra Adhikari> -- to be added by student 3 (if relevant otherwise, student 2 should remove this line)
 */
#include <iostream>
using namespace std;
...
int main() {
    ...
    for (int i = 0; i < ducknum; i++) { 
        ...
        cout << "              <(o )____-" << endl; // student 3(1) may change this line and add additional lines between this line and immediately below
